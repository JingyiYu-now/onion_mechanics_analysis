...
for folder in group:
    ...
    ####### plot the stress-train curve and fitting curve
        ...
        master.set(ylim = [-1.5, 10], xlim = [-5, 40], xlabel = 'Strain (%)', ylabel = 'Stress (MPa)')
...
# lw = 2
# mark = '8'
# sa2.errorbar(x, R_0, yerr = R_0ero, color= 'C7', alpha = 0.6, marker = mark, markersize = ms, linewidth = lw, capsize=5, markeredgewidth= lw)
# sb.errorbar(loadx, R_1, yerr = R_1ero, color='C7', alpha = 0.6)
# sa.errorbar(x, L_l0, yerr = L_l0ero, color='C9', alpha = 0.6, marker = mark, markersize = ms, linewidth = lw, capsize=5, markeredgewidth= lw)
# sb.errorbar(loadx, L_l1, yerr = L_l1ero, color='C9', alpha = 0.6)
# sa.errorbar(x_expo, L_e0, yerr = L_e0ero, color='C3', alpha = 0.6, marker = mark, markersize = ms, linewidth = lw, capsize=5, markeredgewidth= lw)
...
# ax.grid(alpha=0.4, linestyle='--')
# plt.gcf().subplots_adjust(bottom=0.12, right = 0.8, top = 0.95, hspace = 0.35)
